...
<body>
        ...
        <div>Gestion</div>  
          ...
          <table class="table">
            <tr>
              <td>Viviendas</td>
              <td></td>
              <td><a href="index.php?c=Inmobiliaria&a=GestionarViviendas" class="btn btn-warning">Gestionar</a></td>
            </tr>
            <tr>
              <td>Usuario</td>
              <td></td>
              <td><a href="index.php?c=Inmobiliaria&a=GestionarUsu" class="btn btn-warning">Gestionar</a></td>
  ...
  <script>
    /*function listarElementos(pagina){
      ...
      objAjax.open("GET","index.php?c=Inmobiliaria&a=alquier&pagina="+pagina,true);
