          ...
          <div id="card">
            <div class="container-md">
              <div class="row pt-5">
                ...
                <form action="index.php?c=Inmobiliaria&a=BusquedaFiltros_Alquiler" class="form-inline form-filtros" method="POST" name="formFiltros" id="formFechas">
                  <div class="col-xs-10 col-xs-offset-3">
                    <div class="form-group">
                      ...
                      <input type="radio" name="precio" value="<500"><label>&lt;500 </label>
                      <input type="radio" name="precio" value="BETWEEN 500 and 600"><label>500 - 600</label>
                      <input type="radio" name="precio" value="BETWEEN 600 and 700"><label>700 - 800</label>
                      <input type="radio" name="precio" value=">800"><label>&gt;800</label><br>
                      <input type="submit" class="btn btn-warning" value="Buscar" name="busqueda_filtroAlquier">
